...
namespace QL_BanHang.View
{
    public partial class frmHangHoa : Form
    {
        ...
        LoaiHHCtr LoaiHH = new LoaiHHCtr();
        ...
        void load_cb_loaiHH()
        {
            DataTable dataTable = LoaiHH.GetData();
            cbLHH.DataSource = dataTable;
            cbLHH.DisplayMember = "TenLoaiHH";
            cbLHH.ValueMember = "MaLoaiHH";
        }
        ...
        private void addData(HangHoaObj hh)
        {
            ...
            hh.LoaiHH = cbLHH.SelectedValue.ToString();
        }
