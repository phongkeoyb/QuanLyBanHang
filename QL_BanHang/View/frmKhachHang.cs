    ...
    public partial class frmKhachHang : Form
    {
        ...
        private void dtgvDS_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex != -1)
            {
                ...
                txtMa.Text = dtgvDS.Rows[e.RowIndex].Cells["MaKH"].Value.ToString();
                txtTen.Text = dtgvDS.Rows[e.RowIndex].Cells["TenKH"].Value.ToString();
                ...
                txtDiem.Text = dtgvDS.Rows[e.RowIndex].Cells["Diem"].Value.ToString();
                txtEmail.Text = dtgvDS.Rows[e.RowIndex].Cells["Email"].Value.ToString();
            }
        }
    }
}
